...
exports.accentsRemover2 = exports.accentsRemover = void 0;
const accentsRemover = (str) => {
    str = str.toLowerCase().split(' ').join('-');
    return str.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
};
exports.accentsRemover = accentsRemover;
const accentsRemover2 = (str) => {
    return str.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
};
exports.accentsRemover2 = accentsRemover2;
const provincias = {
    ES111: 'A Coruña',
    ES112: 'Lugo',
    ES113: 'Orense',
...
function cleanStringRare(value) {
